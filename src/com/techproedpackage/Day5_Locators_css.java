...
public class Day5_Locators_css {
   ...
   public static void main(String[] args) {
       ...
       //Locate password textbox ve Locate signin button
       WebElement passwordTextBox = driver.findElement(By.cssSelector("input[placeholder='Password']"));
       passwordTextBox.sendKeys("Test1234!");
       // sign in düğmesini tıklayın
       WebElement singinButton = driver.findElement(By.cssSelector("input[value='Sign in']"));
       singinButton.click();
